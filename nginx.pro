...
linux{
#CORE_INCS=$$UNIX_INCS objs
#CORE_DEPS=$$UNIX_DEPS $$LINUX_DEPS
#CORE_SRCS=$$UNIX_SRCS $$LINUX_SRCS

 INCLUDEPATH += $$UNIX_INCS $$HTTP_INCS objs
 HEADERS += $$UNIX_DEPS $$LINUX_DEPS $$REGEX_DEPS $$OPENSSL_DEPS $$HTTP_DEPS $$HTTP_SSL_DEPS \
  $$HTTP_SSI_DEPS \
  ngx_auto_config.h ngx_auto_headers.h

 SOURCES += $$UNIX_SRCS $$LINUX_SRCS $$LINUX_SENDFILE_SRCS $$EPOLL_SRCS $$REGEX_SRCS $$OPENSSL_SRCS \
  $$HTTP_SRCS $$HTTP_SSL_SRCS $$HTTP_FILE_CACHE_SRCS $$HTTP_UPSTREAM_IP_HASH_SRCS $$HTTP_UPSTREAM_LEAST_CONN_SRCS $$HTTP_UPSTREAM_KEEPALIVE_SRCS \
  $$HTTP_AUTOINDEX_SRCS $$HTTP_AUTH_BASIC_SRCS $$HTTP_ACCESS_SRCS $$HTTP_LIMIT_CONN_SRCS $$HTTP_GEO_SRCS $$HTTP_REWRITE_SRCS $$HTTP_REFERER_SRCS \
  $$HTTP_GZIP_SRCS $$HTTP_POSTPONE_FILTER_SRCS $$HTTP_LIMIT_REQ_SRCS $$HTTP_MAP_SRCS $$HTTP_SPLIT_CLIENTS_SRCS $$HTTP_FASTCGI_SRCS $$HTTP_PROXY_SRCS \
  $$HTTP_BROWSER_SRCS $$HTTP_SSI_SRCS $$HTTP_UWSGI_SRCS $$HTTP_SCGI_SRCS $$HTTP_MEMCACHED_SRCS \
  $$HTTP_EMPTY_GIF_SRCS $$HTTP_CHARSET_SRCS $$HTTP_USERID_SRCS $$HTTP_IMAGE_SRCS\
  objs/ngx_modules.c
 LIBS += -lpthread -lcrypt -lpcre -lssl -lcrypto -ldl -lz -lgd
}
...
contains(DEFINES, NGX_HAVE_FILE_AIO){
 SOURCES += $$AIO_SRCS
}
